...
public class ContentData {
    ...
    public enum Content {
        ...
        slideshow, news, event, knowledge, link, calendar, user, personnel, student, schedule, course, lab, academic, research, project, service, qassurance, groupdownload, download, session;
    }
    ...
    public static String getData(String content, String option, String detail) {
        switch (Content.valueOf(content)) {
            ...
            case schedule:
                return Schedule.getData(option, detail);
            case course:
                return Course.getData(option, detail);
            case lab:
                return Lab.getData(option, detail);
            case academic:
            ...
            case service:
                return Service.getData(option, detail);
            case qassurance:
    ...
    public static boolean setData(String content, String option, String data) {
        switch (Content.valueOf(content)) {
            ...
            case schedule:
                return Schedule.setData(option, data);
            case course:
                return Course.setData(option, data);
            case lab:
                return Lab.setData(option, data);
            case academic:
            ...
            case service:
                return Service.setData(option, data);
            case qassurance:
