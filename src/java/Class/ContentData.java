...
public class ContentData {
    ...
    public enum Content {
        ...
        slideshow, news, event, knowledge, link, calendar, user, personnel, student, schedule, course, academic, research, project, service, qassurance, groupdownload, download, session;
    }
