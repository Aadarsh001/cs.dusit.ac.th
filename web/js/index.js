        ...
        success : function (data){
            ...
            $.ajax({
                ...
                success : function (data){
                    ...
                    $('.titlenews.ui-grid-b').append('<div class="ui-block-a"></div><div class="ui-block-b more"></div><a href="allcontent?content=news&option=all"><div class="ui-block-c more">more >></div></a>');
                }
            });
        }
    });
...
function event(){
    $.ajax({
        ...
        success : function (data){
            ...
            $('.subevent.ui-grid-a').append('<div class="ui-block-a more"></div><a href="allcontent?content=event&option=all"><div class="ui-block-b more">more >></div></a>');
        }
    });
}
...
function knowledge(){
    $.ajax({
        ...
        success : function (data){
            ...
            $('.knowledge.ui-grid-a').append('<div class="ui-block-a more"></div><a href="allcontent?content=knowledge&option=all"><div class="ui-block-b more">more >></div></a>');
        }
    });
}
